...
(«ближайший свободный день…», «при бюджете от…»). У карточки `highlights` — короткие сравнения
внутри выдачи («До 12 ч — дольше остальных», «Дешевле ближайшего на 50 000 ₸»), `score_parts` — вклад
