...
| :-: | --- | --- |
| 1 | Нажать **«Фотографы в Алматы»** | Исход «Нашли три подходящих варианта». Три карточки с одинаковыми фактами (цена и % бюджета, свободен, часы, языки), своей строкой «Чем выделяется» и своим объяснением. Раскрывающийся блок «Как посчитан рейтинг» с оценками факторов и весами. Время ответа — сотые доли секунды. Метка «Объяснение по данным» |
